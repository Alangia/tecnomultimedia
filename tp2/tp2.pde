...
void draw() {
  ...
  if (tetris == 1) {
    ...
    drawCenteredText(textos[0], 40, textoY + 40);
  } else if (tetris == 2) {
    image(tetris2, 0, 0, width, height);
    drawCenteredText(textos[1], 40, textoY + 40);
  } else if (tetris == 3) {
    image(tetris3, 0, 0, width, height);
    drawCenteredText(textos[2], 40, textoY + 40);
  } else if (tetris == 4) {
    image(tetris4, 0, 0, width, height);
    image(tetris1, width - 120, height - 60, 100, 50);
    drawCenteredText(textos[3], 40, textoY + 40);
  }
